...
<title>School Event Management System&nbsp;(S.E.M.S)</title> 
  ...
  <div id="header">
    <div id="container" align="center"> 
      ...
      <tbody>
        <tr>
          <td><b>StudentID:</b></td>
          <td><input name="VotingCodes" type="password" id="VotingCodes" placeholder="Enter your ID" required autocomplete="off"></td>
        </tr> 
        <tr>
          <td colspan="2" align="right"><button type="submit" name="submit" class="button"></button></td>
        </tr>
      </tbody>
      </table>
    </div>
