	...
	if(isset($_POST['save'])){
		...
		if ($_POST['President']==''){ 
			...
			$sql ="INSERT `tblvotes` (`Voters`, `Candidate`, `VoteDate`)
			 VALUES ('".$_SESSION['CVCodeNo']."','".$_POST['President']."','".date_format(date_create('Y-m-d'),'Y-m-d') ."')";
			 $mydb->setQuery($sql);
	          $mydb->executeQuery();
		}
		...
		if ($_POST['VicePresident']==''){  
			...
			$sql ="INSERT `tblvotes` (`Voters`, `Candidate`, `VoteDate`)
			 VALUES ('".$_SESSION['CVCodeNo']."','".$_POST['VicePresident']."','".date_format(date_create('Y-m-d'),'Y-m-d') ."')";
			 $mydb->setQuery($sql);
	          $mydb->executeQuery();
		}
		...
		if ($_POST['Secretary']==''){  
			...
			$sql ="INSERT `tblvotes` (`Voters`, `Candidate`, `VoteDate`)
			 VALUES ('".$_SESSION['CVCodeNo']."','".$_POST['Secretary']."','".date_format(date_create('Y-m-d'),'Y-m-d') ."')";
			  $mydb->setQuery($sql);
	          $mydb->executeQuery();
		}
		...
		if ($_POST['Treasurer']==''){  
			...
			$sql ="INSERT `tblvotes` (`Voters`, `Candidate`, `VoteDate`)
			 VALUES ('".$_SESSION['CVCodeNo']."','".$_POST['Treasurer']."','".date_format(date_create('Y-m-d'),'Y-m-d') ."')";
			 $mydb->setQuery($sql);
	          $mydb->executeQuery();
		}
		...
		if ($sen1==''){  
			...
			$sql ="INSERT `tblvotes` (`Voters`, `Candidate`, `VoteDate`)
			 VALUES ('".$_SESSION['CVCodeNo']."','".$sen1."','".date_format(date_create('Y-m-d'),'Y-m-d') ."')";
			 $mydb->setQuery($sql);
	          $mydb->executeQuery();
		}
		...
		if ($sen2==''){  
			...
			$sql = "UPDATE `tblcandidate` SET `TotalVotes`= `TotalVotes` + 1 
	          ...
	          $mydb->executeQuery();
				...
				$sql ="INSERT `tblvotes` (`Voters`, `Candidate`, `VoteDate`)
			 VALUES ('".$_SESSION['CVCodeNo']."','".$sen2."','".date_format(date_create('Y-m-d'),'Y-m-d') ."')";
			 $mydb->setQuery($sql);
	          $mydb->executeQuery();
		}
		if ($sen3==''){  
			...
			$sql = "UPDATE `tblcandidate` SET `TotalVotes`= `TotalVotes` + 1 
	          ...
	          $mydb->executeQuery();
				...
				$sql ="INSERT `tblvotes` (`Voters`, `Candidate`, `VoteDate`)
			 VALUES ('".$_SESSION['CVCodeNo']."','".$sen3."','".date_format(date_create('Y-m-d'),'Y-m-d') ."')";
			 $mydb->setQuery($sql);
	          $mydb->executeQuery();
		}
		if ($sen4==''){  
			...
			$sql = "UPDATE `tblcandidate` SET `TotalVotes`= `TotalVotes` + 1 
	          ...
	          $mydb->executeQuery();
				...
				$sql ="INSERT `tblvotes` (`Voters`, `Candidate`, `VoteDate`)
			 VALUES ('".$_SESSION['CVCodeNo']."','".$sen4."','".date_format(date_create('Y-m-d'),'Y-m-d') ."')";
			 $mydb->setQuery($sql);
	          $mydb->executeQuery();
		}
		if ($sen5==''){  
			...
			$sql = "UPDATE `tblcandidate` SET `TotalVotes`= `TotalVotes` + 1 
	          ...
	          $mydb->executeQuery();
				...
				$sql ="INSERT `tblvotes` (`Voters`, `Candidate`, `VoteDate`)
			 VALUES ('".$_SESSION['CVCodeNo']."','".$sen5."','".date_format(date_create('Y-m-d'),'Y-m-d') ."')";
			 $mydb->setQuery($sql);
	          $mydb->executeQuery();
		}
		if ($sen6==''){  
			...
			$sql = "UPDATE `tblcandidate` SET `TotalVotes`= `TotalVotes` + 1 
	          ...
	          $mydb->executeQuery();
				...
				$sql ="INSERT `tblvotes` (`Voters`, `Candidate`, `VoteDate`)
			 VALUES ('".$_SESSION['CVCodeNo']."','".$sen6."','".date_format(date_create('Y-m-d'),'Y-m-d') ."')";
			 $mydb->setQuery($sql);
	          $mydb->executeQuery();
		}
		if ($sen7==''){  
			...
			$sql = "UPDATE `tblcandidate` SET `TotalVotes`= `TotalVotes` + 1 
	          ...
	          $mydb->executeQuery();
				...
				$sql ="INSERT `tblvotes` (`Voters`, `Candidate`, `VoteDate`)
			 VALUES ('".$_SESSION['CVCodeNo']."','".$sen7."','".date_format(date_create('Y-m-d'),'Y-m-d') ."')";
			 $mydb->setQuery($sql);
	          $mydb->executeQuery();
		}
		if ($sen8==''){  
			...
			$sql = "UPDATE `tblcandidate` SET `TotalVotes`= `TotalVotes` + 1 
	          ...
	          $mydb->executeQuery();
				...
				$sql ="INSERT `tblvotes` (`Voters`, `Candidate`, `VoteDate`)
			 VALUES ('".$_SESSION['CVCodeNo']."','".$sen8."','".date_format(date_create('Y-m-d'),'Y-m-d') ."')";
