                ...
                <table class="table_print"> 
                  ...
                  <tr>
                   ...
                   $sql ="SELECT * FROM `tblcandidate` c, `tblstudent` s
                          ...
                          AND `Position`='President' ORDER BY Lastname asc";
                  $mydb->setQuery($sql);
                  ...
                  <tr>
                   ...
                   $sql ="SELECT * FROM `tblcandidate` c, `tblstudent` s
                          WHERE c.`StudentID`=s.`StudentID` 
                          AND  DATE_FORMAT( `RunningDate` , '%Y' )= DATE_FORMAT(NOW() , '%Y' ) 
                          AND `Position`='Vice-President' ORDER BY Lastname asc";
                 $mydb->setQuery($sql);
                  $cur = $mydb->loadResultList();
                  ...
                  <tr>
                   ...
                   $sql ="SELECT * FROM `tblcandidate` c, `tblstudent` s
                          WHERE c.`StudentID`=s.`StudentID` 
                          AND  DATE_FORMAT( `RunningDate` , '%Y' )= DATE_FORMAT(NOW() , '%Y' ) 
                          AND `Position`='Secretary' ORDER BY Lastname asc";
                 $mydb->setQuery($sql);
                  $cur = $mydb->loadResultList();
                  ...
                  <td colspan="2"><h4 align="center">Treasurer</h4></td>
                   ...
                   $sql ="SELECT * FROM `tblcandidate` c, `tblstudent` s
                          WHERE c.`StudentID`=s.`StudentID` 
                          AND  DATE_FORMAT( `RunningDate` , '%Y' )= DATE_FORMAT(NOW() , '%Y' ) 
                          AND `Position`='Treasurer' ORDER BY Lastname asc";
                  $mydb->setQuery($sql);
                  $cur = $mydb->loadResultList();
