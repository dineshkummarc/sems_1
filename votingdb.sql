...
--
-- Host: localhost
-- Generation Time: Mar 16, 2017 at 04:06 AM
...
(7, 'BASKETBALL', 'A VS B', '2020-02-02', '10:22 pm', 'photo/Chrysanthemum.jpg', 1);
...
CREATE TABLE IF NOT EXISTS `tbleventwinner` (
  `EWID` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `tblvotingcode` (
