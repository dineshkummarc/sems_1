                        ...
                        <li class="dropdown"> 
                            ...
                            <ul class="dropdown-menu"   style="" >
                               ...
                               <!--  <li class="<?php echo (currentpage_public() == 'report') ? "active" : false;?>"><a href="<?php echo web_root; ?>report/index.php?view=candidate">Candidates</a></li>
                                ...
                                <li class="<?php echo ($title == 'Election Winners') ? "active" : false;?>"><a href="<?php echo web_root; ?>report/index.php?view=electionwinners">SSG Election Winners</a></li>
  ...
  <section id="bottoms" style="border-bottom:5px solid #0000 ">
    ...
    <footer id="footer" class="midnight-blue" style="">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; 2018 <a target="_blank" href="<?php echo web_root; ?>" title="Free Twitter Bootstrap WordPress Themes and HTML templates">School Events Management System</a>. All Rights Reserved.
                </div>
              <!--   <div class="col-sm-6">
                    <ul class="pull-right">
                        <li><a href="#">Home</a></li>
